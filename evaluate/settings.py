...
DATABASES = {
    'default': {
        ...
        'NAME': 'evaluate',                      # Or path to database file if using sqlite3.
...
STATIC_URL = os.path.join(HERE, 'static/').replace('\\', '/')
...
SECRET_KEY = '1s9x21+6&ep*q3*zk0^vo=10(wb0pp5m^$#ga35xx7_4o=znk('
